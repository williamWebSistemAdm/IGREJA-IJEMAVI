<?php
    ...
    session_start();
    //Conecчуo com Banco
    include 'conexao.inc.php';//conexуo com o banco
    
    //mensagem de Boas Vindas
        
   //Trazendo perfil do administrador padrao e atribuindo a uma variсvel
    $Adm_padrao = $_SESSION['tipocargo_obr'];
    $nome_adm_padrao = $_SESSION['nome_obr'];
   //Trazendo nome do pastor presidente e atribuindo a uma variсvel
