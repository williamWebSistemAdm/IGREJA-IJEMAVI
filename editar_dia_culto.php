              ...
              <div>
                ...
                <label>Tema do Culto:</label>
              	<input class="form-control" type="text" name="tema_dom" placeholder="Ex: Culto da Faília" required value="<?php echo $nome_culto_dom; ?>" >
							...
							<div class="col-md-2">
                <label>Horário:</label>
              	<input class="form-control" type="time" name="hora_dom" value="<?php echo $hora_culto_dom; ?>">
            	</div>
             </div><br>
<!--
						<h3>Segunda-Feira:</h3><br>
              ...
              <div>
                ...
                <label>Tema do Culto:</label>
              	<input class="form-control" type="text" name="tema_seg" placeholder="Ex: Culto Evangelístico" required value="<?php echo $nome_culto_seg; ?>"  >
							...
							<div class="col-md-2">
                <label>Horário:</label>
              	<input class="form-control" type="time" name="hora_seg" value="<?php echo $hora_culto_seg; ?>">
            	</div>
             </div><br>

						<h3>Terça-Feira:</h3><br>
             <div class="row terca">
              <div>
                ...
                <label>Tema do Culto:</label>
              	<input class="form-control" type="text" name="tema_ter" placeholder="Ex: Culto de Ação Social" required value="<?php echo $nome_culto_ter; ?>" >
							...
							<div class="col-md-2">
                <label>Horário:</label>
              	<input class="form-control" type="time" name="hora_ter" value="<?php echo $hora_culto_ter; ?>">
            	</div>
             </div><br>

						<h3>Quarta-Feira:</h3><br>
              ...
              <div>
                ...
                <label>Tema do Culto:</label>
              	<input class="form-control" type="text" name="tema_qua" placeholder="Ex: Livre" required value="<?php echo $nome_culto_qua; ?>" >
							...
							<div class="col-md-2">
                <label>Horário:</label>
              	<input class="form-control" type="time" name="hora_qua" value="<?php echo $hora_culto_qua; ?>">
            	</div>
             </div><br>

						<h3>Quinta-Feira:</h3><br>
              ...
              <div>
                ...
                <label>Tema do Culto:</label>
              	<input class="form-control" type="text" name="tema_qui" placeholder="Ex: Culto da Vitória" required value="<?php echo $nome_culto_qui; ?>" >
							...
							<div class="col-md-2">
                <label>Horário:</label>
              	<input class="form-control" type="time" name="hora_qui" value="<?php echo $hora_culto_qui; ?>">
            	</div>
             </div><br>
              ...
              <div>
                ...
                <label>Tema do Culto:</label>
              	<input class="form-control" type="text" name="tema_sex" placeholder="Ex: Culto das Rebecas" required value="<?php echo $nome_culto_sex; ?>" >
							...
							<div class="col-md-2">
                <label>Horário:</label>
              	<input class="form-control" type="time" name="hora_sex" value="<?php echo $hora_culto_sex; ?>">
            	</div>
             </div><br>
              ...
              <div>
                ...
                <label>Tema do Culto:</label>
              	<input class="form-control" type="text" name="tema_sab" placeholder="Ex: Culto dos Jovens" required value="<?php echo $nome_culto_sab; ?>" >
							...
							<div class="col-md-2">
                <label>Horário:</label>
              	<input class="form-control" type="time" name="hora_sab" value="<?php echo $hora_culto_sab; ?>">
            	</div>
             </div><br> -->
